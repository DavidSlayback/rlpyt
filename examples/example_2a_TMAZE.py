...
def build_and_train(env_id="TMaze-TwoGoal-v0", run_ID=0, cuda_idx=None, n_parallel=6):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env_id', help='environment ID', default='TMaze-TwoGoal-v0')

...
# Env
from rlpyt.envs.po_fourrooms.po_fourrooms_env import make_po_fourrooms
...
def build_and_train(env_id="FourRooms-v0", run_ID=0, cuda_idx=None, n_parallel=6, fomdp=False):
    ...
    algo = A2C(discount=0.95, learning_rate=lr, clip_grad_norm=2.)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env_id', help='environment ID', default='FourRooms-v0')

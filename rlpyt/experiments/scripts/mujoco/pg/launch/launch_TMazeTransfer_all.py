...
default_config_key = "a2c_1M_TMaze"
experiment_title = "A2C_TMazeTransfer"
variant_levels = list()
lrs = [1e-3, 5e-3, 1e-2]
values = list(zip(lrs))
...
script = path.as_posix()
default_config_key = "ppo_1M_TMaze"
experiment_title = "PPO_TMazeTransfer"
variant_levels = list()
lrs = [3e-5, 1e-4, 3e-4]
values = list(zip(lrs))
...
script = path.as_posix()
default_config_key = "ppoc_1M_TMaze"
experiment_title = "PPOC_TMazeTransfer"
variant_levels = list()
lrs = [3e-5, 1e-4, 3e-4]
delib=[0., 1e-2, 1e-1]
...
script = path.as_posix()
default_config_key = "a2oc_1M_TMaze"
experiment_title = "A2OC_TMazeTransfer"
variant_levels = list()
lrs = [1e-4, 3e-4, 1e-3]
delib=[0., 1e-2, 1e-1]
values = list(zip(delib))
...
path = pathlib.Path(__file__).resolve().parent.parent / 'train' / "mujoco_ff_ppoc_gpu.py"
script = path.as_posix()
default_config_key = "ppioc_1M_TMaze"
experiment_title = "PPIOC_TMazeTransfer"
variant_levels = list()
# lrs = [3e-5, 1e-4, 3e-4]
# delib=[0., 1e-1, 1.]
lrs = [3e-4, 1e-3, 5e-3]
...
path = pathlib.Path(__file__).resolve().parent.parent / 'train' / "mujoco_ff_a2oc_gpu.py"
script = path.as_posix()
default_config_key = "a2ioc_1M_TMaze"
experiment_title = "A2OC_TMazeTransfer"
variant_levels = list()
lrs = [3e-5, 1e-4, 3e-4]
delib=[0., 1e-1, 1.]

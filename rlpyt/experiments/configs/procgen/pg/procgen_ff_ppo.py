...
config = deepcopy(configs['base'])
oc_model = {'option_size': 4, 'use_interest': False}
oc_algo = {'delib_cost': 0., 'omega_entropy_loss_coeff': 0.01, 'termination_loss_coeff': 1., 'normalize_termination_advantage': False, 'clip_pi_omega_loss': False, 'clip_beta_loss': False}
config['model'] = {**config['model'], **oc_model}
config['algo'] = {**config['algo'], ** oc_algo}
configs['base_4_oc'] = config
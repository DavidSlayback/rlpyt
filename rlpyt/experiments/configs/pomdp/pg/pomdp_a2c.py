...
base_env_args = dict(fomdp=False, id='POMDP-hallway-continuing-v0', time_limit=1000)  # Partially-observable, time_limit as in cassandra's thesis
...
base_rnn_args = dict(rnn_type='gru', rnn_size=256, rnn_placement=1, layer_norm=True, prev_action='All', prev_reward='All')  # Base rnn args, best I've seen

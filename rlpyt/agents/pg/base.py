...
# o (for advantage q_o)
AgentInfoOC = namedarraytuple("AgentInfo", ["dist_info", "dist_info_o", "q", "value", "termination", "dist_info_omega", "prev_o", "o"])  # For option critic agents
AgentInfoOCRnn = namedarraytuple("AgentInfo", ["dist_info", "dist_info_o", "q", "value", "termination", "dist_info_omega", "prev_o", "o", "prev_rnn_state"])  # For option critic agents
